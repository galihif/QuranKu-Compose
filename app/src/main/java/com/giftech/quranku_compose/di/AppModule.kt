package com.giftech.quranku_compose.di

import android.content.Context
import androidx.room.Room
import com.giftech.quranku_compose.data.MainRepository
import com.giftech.quranku_compose.data.source.local.LocalDataSource
import com.giftech.quranku_compose.data.source.local.preferences.Preferences
import com.giftech.quranku_compose.data.source.local.room.SurahDao
import com.giftech.quranku_compose.data.source.local.room.SurahDatabase
import com.giftech.quranku_compose.data.source.remote.RemoteDataSource
import com.giftech.quranku_compose.data.source.remote.api.ApiService
